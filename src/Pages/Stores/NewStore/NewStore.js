    ...
    <>
      <div className="form-container">
        <form method="POST" action="/stores" onSubmit={submitStore}>
          ...
          <br />
          <input ref={name} id="name" name="name" type="text" placeholder="Nombre del producto" required></input>
          <br />
          <p>Url del logo</p>
          <br />
          <input ref={logo} id="logo" name="logo" type="text" placeholder="Ingrese URL de la imagen"></input>
          <br />
          <br />

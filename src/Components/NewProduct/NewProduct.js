    ...
    return (
        <div className="new-product-form-container">
            <form method="POST" action="/products">
                ...
                <p>Valor</p><br/>
                <input id="price" name ="price" type="number" placeholder="Precio del producto" required></input><br/>
                <p>Stock</p><br/>
                <input className="p-contador" id="stock" name ="stock" type="number" defaultValue="1"></input><br/>
                <p>Descripción</p><br/>
                <textarea id="description" name ="description" type="textarea" defaultValue="" placeholder="Ingrese información general del producto"></textarea><br/>
                <p>Tienda</p><br/>
                ...
                <p>Nueva imagen</p><br/>
                <input id="image" name ="image" type="text" placeholder="Ingrese URL de la imagen"></input><br/><br/>
                <PreviewImagenes />
